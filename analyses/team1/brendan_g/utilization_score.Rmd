...
"Padding" the client data set results in each client having the same number of observations - each client has 1,021 rows now representing the number of days between the min and max dates:
