...
saveRDS(montgomery_vars, "data/spatial/montgomery_zip_vars.RDS")
st_write(montgomery_vars, "data/spatial/mongomery_zip_vars.gpkg")

write_csv(montgomery_vars %>% 
            as_tibble() %>% 
            select(-geometry), "data/csvs/montgomery_zip_vars.csv")